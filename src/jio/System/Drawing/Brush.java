...
import jio.System.Drawing.*;public abstract class Brush extends MarshalByRefObject implements ICloneable,IDisposable {protected NObject javonetHandle; public Brush(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
