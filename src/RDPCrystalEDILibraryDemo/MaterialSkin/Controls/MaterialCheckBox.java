...
import RDPCrystalEDILibraryDemo.MaterialSkin.*;public class MaterialCheckBox extends CheckBox implements IMaterialControl {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.Boolean getRipple (){ try { return javonetHandle.get("Ripple");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return false;} }/**
	 * SetProperty
	 */
            public void setAutoSize (java.lang.Boolean value){ try { javonetHandle.set("AutoSize",value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * GetProperty
	 */
            public java.lang.Boolean getAutoSize (){ try { return javonetHandle.get("AutoSize");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return false;} }public MaterialCheckBox (){  super((NObject) null); try {  javonetHandle = Javonet.New("MaterialCheckBox"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public MaterialCheckBox(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
