...
import RDPCrystalEDILibraryDemo.MaterialSkin.*;public class MaterialTabControl extends TabControl implements IMaterialControl {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public MouseState getMouseState (){ try { return MouseState.valueOf(((NEnum) javonetHandle.get("MouseState")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public MaterialTabControl (){  super((NObject) null); try {  javonetHandle = Javonet.New("MaterialTabControl"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public MaterialTabControl(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
