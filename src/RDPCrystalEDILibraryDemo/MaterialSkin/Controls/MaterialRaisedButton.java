...
import RDPCrystalEDILibraryDemo.MaterialSkin.*;public class MaterialRaisedButton extends Button implements IMaterialControl {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.String getText (){ try { return  (java.lang.String) javonetHandle.get("Text");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public MaterialRaisedButton (){  super((NObject) null); try {  javonetHandle = Javonet.New("MaterialRaisedButton"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public MaterialRaisedButton(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
