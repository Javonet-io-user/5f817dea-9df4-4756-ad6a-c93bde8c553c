...
import RDPCrystalEDILibraryDemo.MaterialSkin.*;public class MaterialTabSelector extends Control implements IMaterialControl {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * SetProperty
	 */
            public void setBaseTabControl (MaterialTabControl value){ try { javonetHandle.set("BaseTabControl",value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * GetProperty
	 */
            public MaterialTabControl getBaseTabControl (){ try { return new MaterialTabControl((NObject)javonetHandle.get("BaseTabControl"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public MaterialTabSelector (){  super((NObject) null); try {  javonetHandle = Javonet.New("MaterialTabSelector"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public MaterialTabSelector(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
